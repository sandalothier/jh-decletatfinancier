package com.decletatfinancier.decletatfinancier.web.rest;

import com.decletatfinancier.decletatfinancier.config.KafkaProperties;
...
class DecletatfinancierKafkaResourceIT {
    ...
    void setup() {
        ...
        DecletatfinancierKafkaResource kafkaResource = new DecletatfinancierKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/decletatfinancier-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
